...
public class ActiveDeviceDetectionTask extends TaskDefaultImpl {
  ...
  public void runImpl() throws Throwable {
    ...
    for (Entry<String, Long> entry : inactiveUnits.entrySet()) {
      ...
      freeacs.dbi.Syslog syslog = dbi.getSyslog();
      freeacs.dbi.SyslogFilter sf = new freeacs.dbi.SyslogFilter();
      ...
      for (freeacs.dbi.SyslogEntry sentry : entries) {
