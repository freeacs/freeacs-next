...
import freeacs.common.util.TimeWindow;
import freeacs.dbi.util.SystemConstants;
...
public class ServiceWindow {
  private static final Logger log = LoggerFactory.getLogger(ServiceWindow.class);
